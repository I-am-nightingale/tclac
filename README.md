Зачем этот форк?
Потому что у меня на Home Assistant 2026.4.0 с ESPHome 2026.3.3 оригинальный код не работает.
Методы работы с UART поменялись, для register_action стал нужен synchronous=True. В меру своих сил я это исправил. На моем кондиционере (Ballu Discovery DC BSVI-09HN8) проверил работает.


Автор оригинального кода - [I-am-nightingale](https://github.com/I-am-nightingale/tclac)
